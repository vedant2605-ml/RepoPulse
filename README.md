...
**Developed by:**
- [Your Name] - Frontend Development & UI/UX
- [Partner Name] - Backend Development & Database Design
...
- **GetMocha** – For hosting and integrated database
...
*Three persona modes: Developer, HR Manager, General User*

### Analysis Dashboard
![Dashboard](screenshots/dashboard.png)
*Comprehensive repository insights with charts and statistics*
...
**Built with ❤️ for the DBMS course**

[Report Bug](https://github.com/yourusername/RepoPulse/issues) · [Request Feature](https://github.com/yourusername/RepoPulse/issues)
